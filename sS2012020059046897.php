...
<body>
    ...
    <main>
        <div id="product_container">
            ...
            <section class="product_images">
                <div class="small_images">
                    <img class="small_image" id="sS2012020059046897-1" src="assets/images/sS2012020059046897/sS2012020059046897-1.webp" alt="vestido ajustado tejido de canale">
                    <img class="small_image" id="sS2012020059046897-2" src="assets/images/sS2012020059046897/sS2012020059046897-2.webp" alt="vestido ajustado tejido de canale">
                    <img class="small_image" id="sS2012020059046897-3" src="assets/images/sS2012020059046897/sS2012020059046897-3.webp" alt="vestido ajustado tejido de canale">
                </div>
                <div id="bigImage_container" class="big_image">
                    ...
                    <img id="big_image" src="assets/images/sS2012020059046897/sS2012020059046897-1.webp" alt="vestido ajustado tejido de canale">
                    <p id="size_smallScreen" class="size">Tallas: <span>S</span><span>M</span><span>L</span></p>
                </div>
            </section>    
            <section class="product_info">
                    <h1>Vestido ajustado tejido de canalé</h1> 
        ...
        <!-- Recurso https://www.shein.com/SHEIN-Vestido-ajustado-tejido-de-canal%C3%A9-p-6414942-cat-1727.html?share_from=andshother&url_from=GM7238026923230187520 -->
    </main>
    <footer>
