...
<body>
    ...
    <main>
        <div id="product_container">
            ...
            <section class="product_images">
                <div class="small_images">
                    <img class="small_image" id="sw2112088345774072-1" src="assets/images/sw2112088345774072/sw2112088345774072-1.webp" alt="short con cinturon de aro">
                    <img class="small_image" id="sw2112088345774072-2" src="assets/images/sw2112088345774072/sw2112088345774072-2.webp" alt="short con cinturon de aro">
                    <img class="small_image" id="sw2112088345774072-3" src="assets/images/sw2112088345774072/sw2112088345774072-3.webp" alt="short con cinturon de aro">
                    <img class="small_image" id="sw2112088345774072-4" src="assets/images/sw2112088345774072/sw2112088345774072-4.webp" alt="short con cinturon de aro">
                </div>
                <div id="bigImage_container" class="big_image">
                    ...
                    <img id="big_image" src="assets/images/sw2112088345774072/sw2112088345774072-1.webp" alt="short con cinturon de aro">
                    <p id="size_smallScreen" class="size">Tallas: <span>S</span><span>M</span><span>L</span></p>
                </div>
            </section>    
            <section class="product_info">
                    <h1>Short con cinturón con aro O</h1> 
        ...
        <!-- Recurso https://www.shein.com/3-piezas-Shorts-con-cintur%C3%B3n-con-aro-O-p-8688742-cat-1912.html?share_from=andshother&url_from=GM7238027348554641408 -->
    </main>
    <footer>
