...
<body>
    ...
    <main>
        <div id="product_container">
            ...
            <section class="product_images">
                <div class="small_images">
                    <img class="small_image" id="sw2201053252676945-1" src="assets/images/sw2201053252676945/sw2201053252676945-1.webp" alt="Vestido de manga farol de espalda abierta con lazo">
                    <img class="small_image" id="sw2201053252676945-2" src="assets/images/sw2201053252676945/sw2201053252676945-2.webp" alt="Vestido de manga farol de espalda abierta con lazo">
                    <img class="small_image" id="sw2201053252676945-3" src="assets/images/sw2201053252676945/sw2201053252676945-3.webp" alt="Vestido de manga farol de espalda abierta con lazo">
                </div>
                <div id="bigImage_container" class="big_image">
                    ...
                    <img id="big_image" src="assets/images/sw2201053252676945/sw2201053252676945-1.webp" alt="Vestido de manga farol de espalda abierta con lazo">
                    <p id="size_smallScreen" class="size">Tallas: <span>S</span><span>M</span><span>L</span></p>
                </div>
            </section>    
            <section class="product_info">
                    <h1>Vestido de manga farol con lazo</h1> 
        ...
        <!-- Recurso https://www.shein.com/Vestido-de-manga-farol-de-espalda-abierta-con-cord%C3%B3n-p-9708945-cat-1727.html?share_from=andshother&url_from=GM7238027275309051904 -->
    </main>
    <footer>
